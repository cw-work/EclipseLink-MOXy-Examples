package example.gettingstarted.demo4;
...
public class Demo {
    ...
    public static void main(String[] args) throws JAXBException {
        ...
        metadataSourceMap.put("example.gettingstarted.demo1", new StreamSource("./example/gettingstarted/demo4/eclipselink-oxm.xml"));
